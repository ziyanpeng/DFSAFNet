...
from model.DFSAFNet.DFSAFNet import DFSAFNet
...
# define the network
net = DFSAFNet(num_classes=num_classes)
...
train_dataset = PotsdamDataset(data_root='data/vaihingen/train', mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(data_root='data/vaihingen/val',transform=val_aug)
test_dataset = PotsdamDataset(data_root='data/vaihingen/test',
                              transform=val_aug)
