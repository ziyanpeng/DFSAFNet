...
from model.datasets.loveda_dataset import *
...
test_weights_name = "DFSAFNet_e60"  # if save_top_k=3, there are v1,v2 model weights, i.e.xxx-v1, xxx-v2
...
test_dataset = LoveDATrainDataset(data_root='data/LoveDA/Test', mosaic_ratio=0.0,
                                        transform=val_aug)
