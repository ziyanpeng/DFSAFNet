...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default='config/loveda/DFSAFNet.py')
    arg("-o", "--output_path", type=Path, default='test_results/loveda')
    arg("-t", "--tta", help="Test time augmentation.", default="lr", choices=[None, "d4", "lr"]) ## lr is flip TTA, d4 is multi-scale TTA
    arg("--rgb", help="whether output rgb masks", action='store_true',default=True)
