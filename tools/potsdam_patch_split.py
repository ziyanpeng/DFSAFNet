...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="D:\\pbyy\\GeoSeg-main\\data\\potsdam\\test_images")
    parser.add_argument("--mask-dir", default="D:\\pbyy\\GeoSeg-main\\data\\potsdam\\test_masks")
    parser.add_argument("--output-img-dir", default="D:\\pbyy\\GeoSeg-main\\data\potsdam\\test\\images_1024")
    parser.add_argument("--output-mask-dir", default="D:\\pbyy\\GeoSeg-main\\data\potsdam\\test\\masks_1024")
    parser.add_argument("--eroded", action='store_true',default=False,help="是否处理腐蚀的mask")
    parser.add_argument("--gt", action='store_true',default=True,help="是否输出RGB格式的mask")  # output RGB mask
    parser.add_argument("--rgb-image", action='store_false',help="使用Potsdam RGB格式图像")  # use Potsdam RGB format images
    parser.add_argument("--mode", type=str, default='train', help="运行模式")
        ...
        for y in range(0, img.shape[0], stride):
            for x in range(0, img.shape[1], stride):
                ...
                if img_tile.shape[0] == split_size and img_tile.shape[1] == split_size \
                    ...
                    # print(f"Class proportions: {cf}")
                    # print(f"Car class proportion: {cf[4]}")
