...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="D:\\pbyy\\GeoSeg-main\\data\\uavid\\uavid_test")
    parser.add_argument("--output-img-dir", default="D:\\pbyy\\GeoSeg-main\\data\\uavid\\test\\images")
    parser.add_argument("--output-mask-dir", default="D:\\pbyy\\GeoSeg-main\\data\\uavid\\test\\masks")
                ...
                for x in range(0, img.shape[1], stride[1]):
                    ...
                    if img_tile.shape[0] == split_size[0] and img_tile.shape[1] == split_size[1] \
                        ...
                        if mode == 'train':
                            ...
                            # 保存彩色标签
                            mask_rgb = label2rgb(mask_tile)
                            mask_rgb = cv2.cvtColor(mask_rgb, cv2.COLOR_RGB2BGR)
                            cv2.imwrite(out_mask_path, mask_rgb)
