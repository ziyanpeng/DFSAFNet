...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="D:\\pbyy\\GeoSeg-main\\data\\ceshi\\vaihingen\\test_images")
    parser.add_argument("--mask-dir", default="D:\\pbyy\\GeoSeg-main\\data\\ceshi\\vaihingen\\test_masks")
    parser.add_argument("--output-img-dir", default="D:\\pbyy\\GeoSeg-main\\data\\ceshi\\vaihingen\\test\\images_1024")
    parser.add_argument("--output-mask-dir", default="D:\\pbyy\\GeoSeg-main\\data\\ceshi\\vaihingen\\test\\masks_1024")
    parser.add_argument("--eroded", action='store_true',default=False)
    parser.add_argument("--gt", action='store_true',default=True)
